...
public class Liquid0_1
{
    ...
    public Liquid0_1 _WithVolumeAndTemperatureAsDeltaTime()
    {
        Liquid0_1 toReturn = new Liquid0_1();
    ...
    public Liquid0_1 _WithVolumeAsDeltaTime()
    {
        Liquid0_1 toReturn = new Liquid0_1();
    ...
    public Liquid0_1 _WithTemperatureAsDeltaTime()
    {
        Liquid0_1 toReturn = new Liquid0_1();
